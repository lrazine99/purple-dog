      ...
      <div className="container px-4 md:px-6">
        <Card className="border-2 border-primary/20 bg-gradient-to-br from-primary/5 to-accent/5 p-8 shadow-xl md:p-12">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mb-4 font-serif text-3xl font-bold text-foreground md:text-4xl">Restez Informé</h2>
            <p className="mb-8 text-lg text-muted-foreground">
              Recevez nos dernières ventes, conseils d'experts et opportunités exclusives directement dans votre boîte
              mail.
            </p>

            {isSubmitted ? (
              <div className="rounded-lg bg-primary/10 p-4 text-primary">
                <p className="font-medium">Merci ! Vous êtes inscrit à notre newsletter.</p>
              </div>
            ) : (
